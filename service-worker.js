const CACHE_NAME = 'pga-score-v16_5_0';
const ASSETS = ['./','./index.html','./scorer.html','./hq.html','./monitor.html','./public.html','./manifest.webmanifest','./score-colors-v16.5.0.css','./score-colors-v16.5.0.js','./icons/icon-192.png','./icons/icon-512.png'];
