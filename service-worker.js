const CACHE_NAME = 'pga-score-v16_6_0';
const ASSETS = ['./','./index.html','./scorer.html','./hq.html','./monitor.html','./public.html','./manifest.webmanifest','./score-colors-v16.6.0.css','./score-colors-v16.6.0.js','./round-cut-v16.6.0.css','./round-cut-v16.6.0.js','./icons/icon-192.png','./icons/icon-512.png'];
